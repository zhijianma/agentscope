...
from abc import ABC
from typing import Union, Any, List, Sequence, Generator
...
class ZhipuAIChatWrapper(ZhipuAIWrapperBase):
    ...
    def stream_call(
        ...
        **kwargs: Any,
        ...
        API call with stream . It then makes a request to the ZhipuAI API and returns the
        ...
        return self._handle_stream_response(response, stream=stream, messages=messages, **kwargs)
